        ...
        server.addPrompt(
            ...
            GetPromptResult(
                ...
                messages = listOf(
                    ...
                    PromptMessage(
                        role = Role.assistant,
                        content = TextContent(text = "Sure, I'd love to discuss the $topic. What would you like to know?"),
                    ),
                    PromptMessage(
                        role = Role.user,
                    ...
                    PromptMessage(
                        role = Role.assistant,
                        content = TextContent(text = "As an AI, I don't have personal opinions, but I can provide information about $topic."),
                    ),
                    PromptMessage(
                        role = Role.user,
